...
T = TypeVar("T", bound="V20CredOfferConnFreeRequest")
...
class V20CredOfferConnFreeRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v20_cred_offer_conn_free_request = cls(
            filter_=filter_,
        ...
        v20_cred_offer_conn_free_request.additional_properties = d
        return v20_cred_offer_conn_free_request
