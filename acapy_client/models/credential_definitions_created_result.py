...
T = TypeVar("T", bound="CredentialDefinitionsCreatedResult")
...
class CredentialDefinitionsCreatedResult:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        credential_definitions_created_result = cls(
            credential_definition_ids=credential_definition_ids,
        )

        credential_definitions_created_result.additional_properties = d
        return credential_definitions_created_result
