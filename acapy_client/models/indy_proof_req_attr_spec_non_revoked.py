...
T = TypeVar("T", bound="IndyProofReqAttrSpecNonRevoked")
...
class IndyProofReqAttrSpecNonRevoked:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        indy_proof_req_attr_spec_non_revoked = cls(
            from_=from_,
            to=to,
        )

        indy_proof_req_attr_spec_non_revoked.additional_properties = d
        return indy_proof_req_attr_spec_non_revoked
