...
T = TypeVar("T", bound="V10CredentialFreeOfferRequest")
...
class V10CredentialFreeOfferRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v10_credential_free_offer_request = cls(
            connection_id=connection_id,
            cred_def_id=cred_def_id,
            credential_preview=credential_preview,
        ...
        v10_credential_free_offer_request.additional_properties = d
        return v10_credential_free_offer_request
