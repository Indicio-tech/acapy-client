...
T = TypeVar("T", bound="CreateWalletTokenRequest")
...
class CreateWalletTokenRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_wallet_token_request = cls(
            wallet_key=wallet_key,
        )

        create_wallet_token_request.additional_properties = d
        return create_wallet_token_request
