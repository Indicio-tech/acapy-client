...
def _get_kwargs(
    *,
    ...
    role: Union[Unset, None, GetRecordsRole] = UNSET,
    state: Union[Unset, None, GetRecordsState] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        role (Union[Unset, None, GetRecordsRole]):
        state (Union[Unset, None, GetRecordsState]):
