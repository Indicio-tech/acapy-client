...
def _get_kwargs(
    *,
    ...
    role: Union[Unset, None, GetIssueCredentialRecordsRole] = UNSET,
    state: Union[Unset, None, GetIssueCredentialRecordsState] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        role (Union[Unset, None, GetIssueCredentialRecordsRole]):
        state (Union[Unset, None, GetIssueCredentialRecordsState]):
