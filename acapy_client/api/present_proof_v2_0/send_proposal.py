...
from ...models.v20_pres_proposal_request import V20PresProposalRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: V20PresProposalRequest,
) -> Dict[str, Any]:
    url = "{}/present-proof-2.0/send-proposal".format(client.base_url)
