...
T = TypeVar("T", bound="IndyPresSpecRequestedAttributes")


@attr.s(auto_attribs=True)
class IndyPresSpecRequestedAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        indy_pres_spec_requested_attributes = cls()
        ...
        indy_pres_spec_requested_attributes.additional_properties = additional_properties
        return indy_pres_spec_requested_attributes
